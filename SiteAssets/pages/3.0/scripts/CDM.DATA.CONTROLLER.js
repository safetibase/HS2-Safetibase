...
cdmdata = {
    get: function(lst, filter, order, format, trg ,flst,wpt) {
        ...
        getListFields(lst,flst)
            ...
            if (format == "frmsel_hs2residualriskowner") {
                tposSelectdropdown(lst, data, trg,"cdmhs2residualriskowner");
            }
            if (format == "frmsel_HS2RailSystemsContracts") {
                tposSelectdropdown(lst, data, trg,"cdmHS2RailSystemsContracts");
            }
...
function xtrafilter(lst, flt, title) {
    ...
    var ctwf = 'cdmTW';
    var crmf = 'cdmRAMS';
    var poslists = ['cdmSites', 'cdmPWStructures', 'cdmStagesHS2', 'cdmPWElementTerms', 'cdmCompanies', 'cdmHazardTypes'];
    var posfilters = ['cdmSite', 'cdmPWStructure', 'cdmStageHS2', 'cdmPWElement', 'cdmHazardOwner', 'cdmHazardType'];
