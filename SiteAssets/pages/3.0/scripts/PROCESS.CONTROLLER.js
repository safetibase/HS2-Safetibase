            ...
            if (o == '<span class="clr_5">Unassigned</span>') {
                ...
                if (!uce) {
                    ...
                    if (fld == "cdmhs2residualriskowner") {
                        ...
                        cdmdata.get("cdmHS2ResidualRiskOwner", "", null, "frmsel_hs2residualriskowner", hc,null,[]);
                    }
                    ...
                    if (fld == "cdmHS2RailSystemsContracts") {
                        gimmepops(
                            "Assigning a HS2 Rail Systems Contracts",
                            '<div id="popscontentarea"><i class="fa fa-spinner fa-spin"></i> Loading data</div>'
                        );
                        cdmdata.get("cdmHS2RailSystemsContracts", "", null, "frmsel_HS2RailSystemsContracts", hc,null,[]);
                    }
                    if (fld == "cdmPWElement") {
                        gimmepops(
...
function tposcustomfilters( data) {
    ...
    for (var cc = 0; cc < tlist.length; cc++) {
      var it = tlist[cc];
      var itid = it.cdmStageHS2.ID;
      var ittitle = it.cdmStageHS2.Title;
      ...
      if (!distlistcdmStageHS2.includes(ittitle)){
        ...
        selectcdmstagehs2 += '<option value='+ittitle+'>'+ittitle+'</option>'
      }
    ...
    $(".pops-content").append(
      ...
      +"</select><br> </div>"+
      '<div class ="customfiltersection" id="popscontentarea2"> <select name="cdmstagehs2filter[]" multiple id="cdmstagehs2filter">' +  selectcdmstagehs2
      +"</select><br> </div>"+
            ...
            if (a == "initiatereview") {
                ...
                if (a == "clientreview") {
                    ...
                    if (vcheck === null || vcheck === 'undefined' || vcheck === '') {
                        ...
                        tdata.push("cdmReviews|" + nl);
                        tdata.push("cdmCurrentStatus|Ready for Review by HS2");
                        tdata.push("cdmLastReviewDate|" + ind);
